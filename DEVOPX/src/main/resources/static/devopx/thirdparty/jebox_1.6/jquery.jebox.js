...
;!(function ( window, factory ) {
    ...
    /*jeBox.open = function () {
        return jeBox($.extend({
            ...
            padding:"0",
            boxSize:['430px', '430px'],
            content: "https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=gQFA8TwAAAAAAAAAAS5odHRwOi8vd2VpeGluLnFxLmNvbS9xLzAyeFRvelUzQ1BjbkQxR05mNTF1Y3cAAgSpiIVeAwQIBwAA",
            maskClose:true
        }, !type && function () {
            options = options || {};
            return options;
